...
import os
# os.environ["CPATH"] = '/usr/local/cudnn/4.0.7:'#+os.environ["CPATH"]
# os.environ["LIBRARY_PATH"] = '/usr/local/cudnn/4.0.7:'#+os.environ["LIBRARY_PATH"]
# os.environ["LD_LIBRARY_PATH"] = '/usr/local/cuda-7.5/lib64:/usr/local/cudnn/4.0.7:'#+os.environ["LD_LIBRARY_PATH"]
# os.environ["THEANO_FLAGS"] = 'mode=FAST_RUN,device=gpu2,floatX=float32,dnn.enabled=True'
